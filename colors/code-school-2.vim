" Vim color file
" Converted from Textmate theme Code School 2 using Coloration v0.3.3 (http://github.com/sickill/coloration)
...
let g:colors_name = "code-school-2"
...
hi LineNr ctermfg=102 ctermbg=23 cterm=NONE guifg=#84898c guibg=#2e373b gui=NONE
hi VertSplit ctermfg=59 ctermbg=59 cterm=NONE guifg=#575e61 guibg=#575e61 gui=NONE
...
hi Normal ctermfg=231 ctermbg=16 cterm=NONE guifg=#f0f0f0 guibg=#182227 gui=NONE
...
hi SpecialKey ctermfg=59 ctermbg=23 cterm=NONE guifg=#414e58 guibg=#2e373b gui=NONE
...
hi Type ctermfg=153 ctermbg=NONE cterm=underline guifg=#b5d8f6 guibg=NONE gui=underline
